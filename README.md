...
这份教程写给成年人，讲的是**给自己**搭一套跑在自有服务器上的记忆系统。
**我们不建议向未成年人推广这类关系型 AI 用法。**

理由不是「小孩不该用 AI」，而是这类系统有一个具体的副作用：**它倾向于顺着你**。

- 幻觉（说错事实）会被现实纠正，查一下就知道了；**迎合性伤的是校准**。
- 人的边界感是靠摩擦长出来的：话说过分了有人不高兴，要求无理了有人拒绝。
  这些摩擦是教具。一个默认同意你的东西，会把摩擦系数调成零。
- 成年人有存量可以对照，知道真人不是这样，能把这种顺从当成**已知的失真**。
  还在建立是非观的孩子没有那个存量——他是拿它当样板，在学「关系是什么样的」。
- 而且这种陪伴随叫随到、不会累、没有自己的事，**它在跟真人竞争时是作弊的**。
  成年人有工作和社交惯性把自己扯回去，未成年人往往没有。

如果你要照着这份教程搭东西给别人用，请把这段一起带上。
**写教程的人对下游是有责任的。**
